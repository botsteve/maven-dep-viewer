...
import org.example.utils.ForceDeleteUtil;
...
import static org.example.utils.FxUtils.*;
import static org.example.utils.ProxyUtil.*;
            ...
            paths.filter(Files::isDirectory)
                    .forEach(path -> {
                        try {
                            ...
                            throw new RuntimeException("Cleanup process stopped due to error", e);
                        }
                    });
        }
    }
