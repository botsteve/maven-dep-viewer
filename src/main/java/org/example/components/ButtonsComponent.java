...
import static org.example.utils.Utils.arePropertiesConfiguredAndValid;
import static org.example.utils.Utils.collectLatestVersions;
...
import lombok.Data;
import org.example.tasks.BuildRepositoriesTask;
import org.example.tasks.DependencyDownloaderTask;
import org.example.tasks.DependencyLoadingTask;
...
public class ButtonsComponent {
  ...
  public Button createBuildSelectedButton(ProgressBar progressBar, Label progressLabel) {
    Button buildButton = new Button("Build Downloaded");
