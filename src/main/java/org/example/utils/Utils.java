...
public class Utils {
  ...
  public static void createSettingsFile() {
    String filePath = "env-settings.properties";
  ...
  private static boolean isValidJdkHome(File jdkHome) {
    return !new File(jdkHome, "bin").isDirectory() ||
           !new File(jdkHome, "lib").isDirectory() ||
           !new File(jdkHome, "include").isDirectory() ||
           !new File(jdkHome, "bin/java").isFile() ||
           !new File(jdkHome, "bin/javac").isFile();
  }
